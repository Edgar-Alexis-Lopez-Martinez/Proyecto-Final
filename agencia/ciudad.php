...
$id = $_GET['id'];
$estados = $Estados->readEstado_Ciudad($id);
        ...
        ?>
            <?php if ($renglon % 3 == 0 or $renglon == 1) :
                ...
                <div class="col">
                    ...
                    <h2><?php echo $estado["ciudad"]; ?></h2>
                    <?php foreach ($ciudades as $ciudad) : ?>
                    <?php endforeach; ?>
                    <p><a class="btn btn-secondary" href="pase.php?id=<?php echo $ciudad['id_ciudad']; ?>">Ver Mas &raquo;</a></p>
                </div>
                <?php
                if ($columnas == 3) : ?>
                </div><!-- /.row -->
