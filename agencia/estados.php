  ...
  <div id="wrapper" class="container-fluid">
    ...
    ?>
      <?php if ($renglon % 3 == 0 or $renglon == 1) :
        ...
        <div class="col">
          <?php $columnas++; ?>
          <img class="rounded-circle" src="<?php echo $estado["foto"]; ?>">
          <h2><?php echo $estado["estado"]; ?></h2>
          <p><?php echo $estado["descripcion"]; ?></p>
          <p><a class="btn btn-secondary" href="ciudad.php?id=<?php echo $estado['id_estado']; ?>" role="button">Ver Mas &raquo;</a></p>
        </div>
        <?php if ($columnas == 3) : ?>
        </div><!-- /.row -->
      <?php endif; ?>
